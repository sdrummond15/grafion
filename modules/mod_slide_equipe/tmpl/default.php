    ...
    jQuery(function () {
        ...
        jQuery(window).on('resize', function () {
            ...
            if (largura > 1170) {
                ...
                jQuery('#modslide_equipes .slider').css('width', 1170);

            }

            if (largura <= 1170 && largura > 960) {

                jQuery('#modslide_equipes .slider').css('width', 876);

            }

            if (largura <= 960 && largura > 660) {

                jQuery('#modslide_equipes .slider').css('width', 584);

            }

            if (largura <= 660 && largura > 0) {

                jQuery('#modslide_equipes .slider').css('width', 292);
