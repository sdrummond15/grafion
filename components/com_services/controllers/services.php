...
class ServicesControllerServices extends JControllerForm

{

    public function enviarservice()

    {
        ...
        PHP_email::email_service($nome, $empresa, $telefone, $email, $solicitacao);
...

{
    ...
    function email_service($nome, $empresa, $telefone, $email, $solicitacao)
